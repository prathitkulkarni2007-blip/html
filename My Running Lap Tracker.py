 ...
 # Find the total running points after n laps using three differnt solutions.
 ...
 print("Steps Taken:", steps_total)
 print("Time Complexity: 0(n^2)")
 print("Space Complexity: 0(1)")
 print()
 ...
 print("==================================")
 print("ALGORITHM EFFICIENCY COMPARSION")
 print("==================================")
