...
st.set_page_config(page_title="AI Visionary", page_icon="🦋", layout="centered")

STYLES = {
    "Normal":(
       "Look at this image carefully and write a clear, detailed report. "
       "Describe the scence, objects, and what seems to be happening."
    ),
    "Funny": (
    ...
    "Story Mode": (
        "Look at this image and write a short story-like scence descrition. "
