  ...
  with open("science-note.txt", "w") as f:
      f.writelines(science_notes)

  with open("maths-note.txt", "w") as f:
  ...
  # -------------------------------------------------------------------
  # PART 3 - CHECK IF MERGED FILE EXITS
  # -------------------------------------------------------------------
  ...
  if os.path.exists(merged_file):
      ...
      print("No old merged file remove.")
 ...
 print("
 ============================")
 print("STUDY NOTES ORGANIZER SUMMMARY")
 print("============================")
 print("with open() as f: Used for safe file handing.")
