 ...
 # Left Shifts and Right Shift | Odd or Even with XOR | Counting Bits
 ...
 print(" ==================================")
 print("Serect Code:", secret_code, "Binary:", bits(secret_code))
 ...
 print("Access Key Binary:", bits(access_key))
  ...
  # PART 4 - LEFT SHTFT and RIGHT SHIFT
  left_shift = secret_code << 1
  right_shift = secret_code >> 1

  print("
  PART 4: Left Shift and Right Shift")
  print("Left Shift Result:", left_shirt, "Binary:", bits(left_shift, 5))
  ...
  print("OR:", or _result)
  print("NOT winthin 4 bits:", not_result)
  print("XOR:", xor_result)
  print("Left Shifts:", left_shift)
